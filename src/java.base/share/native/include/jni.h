...
#ifdef __cplusplus
using jboolean = bool;
static_assert(sizeof(jboolean) == sizeof(unsigned char), "jboolean size mismatch");
#else
typedef _Bool           jboolean;
_Static_assert(sizeof(jboolean) == sizeof(unsigned char), "jboolean size mismatch");
#endif
...
// I would reorder this for packing but it would break the ABI of existing DLLs
...
_JNI_IMPORT_OR_EXPORT_ jint JNICALL
JNI_GetCreatedJavaVMs(JavaVM **, jsize, jsize * __restrict);

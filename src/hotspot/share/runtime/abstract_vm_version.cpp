...
const char* Abstract_VM_Version::internal_vm_info_string() {
    ...
    #define HOTSPOT_BUILD_USER unknown
        ...
        #define HOTSPOT_BUILD_SUBCOMPILER " (clang-cl " __VERSION__ ")"
      #else
        #define HOTSPOT_BUILD_SUBCOMPILER ""
      #endif
      #if _MSC_VER == 1600
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 10.0 (VS2010)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1700
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 11.0 (VS2012)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1800
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 12.0 (VS2013)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1900
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 14.0 (VS2015)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1911
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.3 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1912
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.5 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1913
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.6 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1914
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.7 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1915
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.8 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1916
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 15.9 (VS2017)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1920
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.0 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1921
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.1 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1922
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.2 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1923
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.3 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1924
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.4 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1925
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.5 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1926
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.6 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1927
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.7 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1928
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.8 (VS2019)" HOTSPOT_BUILD_SUBCOMPILER
      #elif _MSC_VER == 1929
        #define HOTSPOT_BUILD_COMPILER "MS VC++ 16.9 (VS202A)" HOTSPOT_BUILD_SUBCOMPILER
      #else
        #define HOTSPOT_BUILD_COMPILER "unknown MS VC++:" XSTR(_MSC_VER) HOTSPOT_BUILD_SUBCOMPILER
      #endif
      #if defined(__clang_version__)

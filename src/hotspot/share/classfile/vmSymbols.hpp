...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_dfloor,                   java_lang_Math,         floor_name, double_double_signature,           F_S)   \
  do_intrinsic(_dceil,                    java_lang_Math,         ceil_name,  double_double_signature,           F_S)   \
  do_intrinsic(_drint,                    java_lang_Math,         rint_name,  double_double_signature,           F_S)   \
  do_intrinsic(_ffloor,                   java_lang_Math,         floor_name, float_float_signature,             F_S)   \
  do_intrinsic(_fceil,                    java_lang_Math,         ceil_name,  float_float_signature,             F_S)   \
  do_intrinsic(_frint,                    java_lang_Math,         rint_name,  float_float_signature,             F_S)   \

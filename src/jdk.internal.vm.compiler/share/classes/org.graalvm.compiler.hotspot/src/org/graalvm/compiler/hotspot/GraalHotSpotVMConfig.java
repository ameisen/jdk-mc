...
public class GraalHotSpotVMConfig extends GraalHotSpotVMConfigAccess {
    ...
    public final int shenandoahSATBQueueBufferOffset;
    {
        if (JDK <= 8) {
            ...
            g1YoungCardValue = getConstant("G1CardTable::g1_young_gen", Byte.class, (byte)-1);
            g1SATBQueueMarkingOffset = getConstant("G1ThreadLocalData::satb_mark_queue_active_offset", Integer.class, -1);
            g1SATBQueueIndexOffset = getConstant("G1ThreadLocalData::satb_mark_queue_index_offset", Integer.class, -1);
